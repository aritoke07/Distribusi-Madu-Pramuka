                  ...
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        echo form_dropdown('id_madu', $optionMadu, $id_madu, 'class="form-control col-md-7 col-xs-12" required="required"  id="id_madu" disabled');
                        ?>
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          echo form_dropdown('status', $optionStatus, $status, 'class="form-control col-md-7 col-xs-12" required="required"  id="status" disabled');
                          ?>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" placeholder="Jumlah" required="required" id="jumlah" name="jumlah" value="<?=$jumlah?>" disabled>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button type="button" class="btn btn-success" id="_btnPrint_" name="_btnPrint_" onclick="window.open('<?=site_url("app/stok/print_pdf/".$id_stok)?>', '_blank')">Print</button>
                        </div>
                      </div>
                    </form>
                  </div>
