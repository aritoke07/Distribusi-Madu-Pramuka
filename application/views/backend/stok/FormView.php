                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" novalidate>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" placeholder="Jumlah" required="required" id="jumlah" name="jumlah" value="<?=$jumlah?>" <?=$jumlahDisable?>>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select class="form-control col-md-7 col-xs-12" id="id_kemasan" name="id_kemasan"><option value="">- Pilih -</option></select>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" placeholder="Harga" id="harga" name="harga" disabled />
