                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" method="post" novalidate>
                      <input type="hidden" id="id_kedai" name="id_kedai" value="<?=$id_kedai?>">
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nama Kedai</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" class="form-control col-md-7 col-xs-12" placeholder="Nama Kedai" required="required" id="nama" name="nama" value="<?=$nama?>" <?=$namaDisable?>>
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Kota</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <?php
                          $optionKota[''] = '- Pilih -';
                          foreach ($valKota as $val) {
                            $optionKota[$val->id_kota] = ucfirst($val->nama);
                          }
                          echo form_dropdown('id_kota', $optionKota, $id_kota, 'class="form-control col-md-7 col-xs-12" '.$id_kotaDisable.' required="required"  id="id_kota"');
                          ?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="button" class="btn btn-primary" id="_btnCancel_" name="_btnCancel_" onclick="location.href='<?=site_url("app/kedai/")?>'">Kembali</button>
