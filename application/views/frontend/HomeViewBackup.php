...
<html lang="en">
  ...
  <body>
            ...
            <span style="display:none;font-weight:bold; position:absolute;color: grey;position: absolute;padding:4px;font-size: 11px;background-color:rgba(128, 128, 128, 0.26);z-index: 17;  right: 27px; top: 5px;" id="span_loginpsw"></span><!---Alredy exists  ! -->
                  ...
                  <div class="row">
                      ...
                      <div class="col-xs-12">
                          ...
                          <a href="<?=site_url('register')?>" class="btn btn-success btn-block btn-flat">Register</a>
                      </div>
                  </div>
                </form>
              </div>
    ...
    <!--/ Modal box-->
    <!--Banner-->
    <div class="banner" style="background-image: url(<?=site_url('assets/frontend/img/flores-pertanian-1.jpg')?>);">
      <div class="bg-color">
        <div class="container">
          <div class="row">
            ...
            <div class="pm-staff-profile-container" >
              <div class="pm-staff-profile-image-wrapper text-center">
                <div class="pm-staff-profile-image">
                  <img src="<?=site_url('assets/frontend/img/mentor.jpg')?>" alt="" class="img-thumbnail img-circle" />
                </div>   
              </div>                                
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course01.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
          ...
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course02.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
              </figcaption>
          ...
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course03.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
              </figcaption>
          ...
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course04.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
              </figcaption>
          ...
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course05.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
              </figcaption>
          ...
          <div class="col-md-4 col-sm-6 padleft-right">
            <figure class="imghvr-fold-up">
              <img src="<?=site_url('assets/frontend/img/course06.jpg')?>" class="img-responsive">
              <figcaption>
                  <h3>Course Name</h3>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam atque, nostrum veniam consequatur libero fugiat, similique quis.</p>
              </figcaption>
